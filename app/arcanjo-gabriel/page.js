...
export default function ArcanjoGabrielPage() {
  ...
  return (
    <div style={{ background: '#0a0f1e', minHeight: '100vh', paddingBottom: '90px' }}>
      ...
      <div style={{ position: 'relative', height: '280px', overflow: 'hidden' }}>
        <img src="/images/arcanjo-gabriel.png" alt="Arcángel Gabriel"
      ...
      <div style={{ padding: '24px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ color: 'white', fontSize: '13px', fontWeight: 600, fontFamily: 'Lato, sans-serif', marginBottom: '8px' }}>
              Oración de Prosperidad al Arcángel Gabriel
            </div>
            <div style={{
          ...
          <audio ref={audioRef} src="/audios/arcanjo-gabriel.mp3"
        ...
        <div style={{
          ...
          {[
            'Gabriel, mensajero de la presencia divina,\nque anunciaste a nuestros padres la Alianza,\nsé hoy mi guía para que pueda recibir\ntodo lo que mi alma necesita.',
            'Abre mi mente a las buenas decisiones,\nhaz que mi corazón comprenda los\nverdaderos propósitos y caminos.',
            'Abre mis puertas y cierra las indebidas,\naleja de mí toda duda y todo mal,\ny transmuta en bendición lo que aún\nno entiendo de mi caminar.',
            'Que tu luz me acompañe cada día,\ncon generosidad, paz y gratitud,\ny que la abundancia perfecta\llegue a mi vida en todas sus formas.',
            'Amén así sea.',
          ].map((paragrafo, i) => (
            <p key={i} style={{
